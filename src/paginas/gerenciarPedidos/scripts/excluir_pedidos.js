async function apagarPedido(index) {
    let excluirResponse = await fetch('../../../controle/excluir_pedido_controle.php', {
        method: "POST",
        headers: {
    ...
    let pedidoExcluido = await excluirResponse.json()

    if(!pedidoExcluido['status']) return
